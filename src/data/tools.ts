...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    faqs: [{ question: "Why convert day rate to hourly?", answer: "It helps compare client proposals that mix hourly, daily, and project pricing." }],
  ...
  },
  {
    ...
    faqs: [{ question: "Is the tax percentage accurate?", answer: "No. It is a reserve assumption for planning. Ask a qualified professional for tax-specific guidance." }],
  ...
  },
  {
    ...
    faqs: [{ question: "How much contingency should I add?", answer: "Many freelancers start with 10–25% depending on scope clarity, revision risk, and client responsiveness." }],
  ...
  },
  {
    ...
    faqs: [{ question: "Why add an availability premium?", answer: "Retainers reserve capacity and reduce your ability to sell that time elsewhere." }],
  ...
  },
  {
    ...
    faqs: [{ question: "What utilization is realistic?", answer: "It varies by business model. Solo freelancers often need room for sales, admin, learning, and unpaid communication." }],
  ...
  },
  {
    ...
    faqs: [{ question: "Can I always charge this?", answer: "No. Late fees depend on your contract and applicable rules. Treat this as a math helper only." }],
  ...
  },
  {
    ...
    faqs: [{ question: "Are these official Stripe fees?", answer: "The defaults are an example. Always verify the current fee schedule in your Stripe account and country." }],
  ...
  },
  {
    ...
    faqs: [{ question: "Why is the fee editable?", answer: "Platform fee schedules can change by contract, country, or date. Editable inputs make the math reusable." }],
  ...
  },
  {
    ...
    faqs: [{ question: "What rate should I use?", answer: "Use a blended loaded cost for employees or the average billable/market rate for freelancers and consultants." }],
